<form action="{{ route('doctors.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="row row-xs align-items-center mg-b-20">
        ...
        <div class="col-md-8 mg-t-5 mg-md-t-0">
            <select class="form-control" name="department_id">
                <option value="" disabled selected>--- {{ __('handle.select.department') }} ----</option>
    ...
    <div class="row row-xs align-items-center mg-b-20">
        <div class="col-md-4">
            <label class="form-label mg-b-0">
                {{ __('field.number_of.appointments') }}:
            </label>
        </div>
        <div class="col-md-8 mg-t-5 mg-md-t-0">
    ...
    <div class="row row-xs align-items-center mg-b-20">
        ...
        <div class="col-md-8 mg-t-5 mg-md-t-0">
            <textarea id="AboutMe" name="bio" class="form-control" rows="5"></textarea>
            @error('bio')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>

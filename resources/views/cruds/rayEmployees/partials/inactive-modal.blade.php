<div class="modal" id="rayEmployees-inactivate-{{ $rayEmployee->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ $rayEmployee->name }}</h6>
            ...
            <div class="modal-footer">
                <form action="{{ route('rayEmployees.inactivate', $rayEmployee->id) }}" method="POST">
                    @csrf
                    @method('PUT')

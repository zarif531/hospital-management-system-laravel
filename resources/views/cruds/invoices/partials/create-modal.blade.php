<div class="modal" id="invoices-create">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <select name="doctor_id" class="form-control select2-show-search select2-dropdown">
                                <option disabled selected>{{ __('handle.select.doctor') }}</option>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <select name="service_id" class="form-control select2-show-search select2-dropdown">
                                <option disabled selected>{{ __('handle.select.service') }}</option>
                        ...
                        <div class="col">
                            ...
                            <select name="case" class="form-control SlectBox SumoUnder">
                                <option disabled selected>{{ __('handle.select.invoice_case') }}</option>
                                <option value="paid">{{ __('const.case.paid') }}</option>
                                <option value="pending">{{ __('const.case.pending') }}</option>
                            </select>
                            @error('case')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror

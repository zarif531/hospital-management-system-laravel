<div class="modal" id="labEmployees-delete-{{ $labEmployee->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <form action="{{ auth()->guard('admin')->check() ? route('labEmployees.destroy', $labEmployee->id) : route('labEmployee.destroy') }}" method="POST">
                    @csrf
                    @method('DELETE')

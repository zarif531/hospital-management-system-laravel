<div class="modal" id="labs-diagnosis-{{ $lab->id }}">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">
                    {{ __('cruds.labs') }} | {{ __('field.diagnosis') }}
                </h6>
            ...
            <div class="modal-body">
                <form action="{{ route('labEmployee.labs.diagnosis', $lab->id) }}" method="POST"
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <textarea name="diagnosis" rows="3" class="form-control">{{ $lab->diagnosis }}</textarea>
                            @error('diagnosis')

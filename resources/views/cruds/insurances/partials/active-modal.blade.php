<div class="modal" id="insurances-activate-{{ $insurance->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">
                    {{ __('cruds.insurances') }} | {{ __('const.status.activation') }}
                </h6>
            ...
            <div class="modal-footer">
                <form action="{{ route('insurances.activate', $insurance->id) }}" method="POST">
                    @csrf
                    @method('PUT')

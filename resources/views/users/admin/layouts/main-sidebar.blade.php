...
@section('side-menu')
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('doctors.index') }}">{{ __('users.doctors') }}</a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('patients.index') }}">{{ __('users.patients') }}</a>
            </li>
            <li>
                <a class="slide-item"
                    href="{{ route('labEmployees.index') }}">{{ __('users.labEmployees') }}</a>
            </li>
            <li>
                <a class="slide-item"
                    href="{{ route('rayEmployees.index') }}">{{ __('users.rayEmployees') }}</a>
            </li>
            <li>
                <a class="slide-item"
                    href="{{ route('ambulanceDrivers.index') }}">{{ __('users.ambulanceDrivers') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li><a class="slide-item"
                    href="{{ route('single-services.index') }}">{{ __('cruds.services.single') }}</a>
            </li>
            <li><a class="slide-item"
                    href="{{ route('multi-services.index') }}">{{ __('cruds.services.multi') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{ route('invoices.index') }}">
            ...
            <span class="side-menu__label">{{ __('cruds.invoice.*') }}</span>
        </a>
    </li>

    <li class="slide">
        <a class="side-menu__item" href="{{ route('receipts.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            </svg><span class="side-menu__label">{{ __('cruds.receipt.*') }}</span>
        </a>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{ route('payments.index') }}">
            ...
            <span class="side-menu__label">{{ __('cruds.payment.*') }}</span>
        </a>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{ route('fund-accounts.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
            ...
            <span class="side-menu__label">{{ __('cruds.accounts.fund') }}</span>
        </a>
    </li>

    <li class="side-item side-item-category">
        {{ __('users.doctors') . ' & ' . __('users.patients') }}
    </li>
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('appointments.index', 'all') }}">
                    {{ __('statistics.all.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('appointments.index', 'pending') }}">
                    {{ __('statistics.pending.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('appointments.index', 'in-progress') }}">
                    {{ __('statistics.in-progress.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('appointments.index', 'completed') }}">
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('diagnostics.index', 'all') }}">
                    {{ __('statistics.all.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('diagnostics.index', 'pending') }}">
                    {{ __('statistics.pending.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('diagnostics.index', 'in-progress') }}">
                    {{ __('statistics.in-progress.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('diagnostics.index', 'completed') }}">
                    {{ __('statistics.completed.') }}
                </a>
            </li>
        </ul>
    ...
    <li class="slide">
        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
            ...
            <span class="side-menu__label">{{ __('cruds.labs') }}</span>
            <i class="angle fe fe-chevron-down"></i>
        </a>
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('labs.index', 'all') }}">
                    {{ __('statistics.all.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('labs.index', 'pending') }}">
                    {{ __('statistics.pending.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('labs.index', 'completed') }}">
                    {{ __('statistics.completed.') }}
                </a>
            </li>
        </ul>
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('rays.index', 'all') }}">
                    {{ __('statistics.all.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('rays.index', 'pending') }}">
                    {{ __('statistics.pending.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('rays.index', 'completed') }}">
                    {{ __('statistics.completed.') }}
                </a>
            </li>
        </ul>
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{ route('departments.index') }}">
            ...
            <span class="side-menu__label">{{ __('cruds.departments') }}</span>
        </a>
    </li>

    <li class="slide">
        <a class="side-menu__item" href="{{ route('ambulances.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
            ...
            <span class="side-menu__label">{{ __('cruds.ambulances') }}</span>
        </a>
    </li>

    <li class="slide">
        <a class="side-menu__item" href="{{ route('insurances.index') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
            ...
            <span class="side-menu__label">{{ __('cruds.insurances') }}</span>
        </a>
    </li>
@endsection

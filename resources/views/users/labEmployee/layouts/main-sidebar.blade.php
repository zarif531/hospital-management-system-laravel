...
@section('side-menu')
    ...
    <li class="slide">
        <a class="side-menu__item" href="{{ route('labEmployee.dashboard') }}">
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            <li>
                <a class="slide-item" href="{{ route('labEmployee.labs.index', 'all') }}">
                    {{ __('statistics.all.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('labEmployee.labs.index', 'pending') }}">
                    {{ __('statistics.pending.') }}
                </a>
            </li>
            <li>
                <a class="slide-item" href="{{ route('labEmployee.labs.index', 'completed') }}">

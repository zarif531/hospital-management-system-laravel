        ...
        <div class="main-header-profile bg-primary p-3">
            <div class="d-flex wd-100p">
                <div class="main-img-user">
                    <img alt="" src="{{ asset('backend/images/' . $rayEmployee->image->path) }}" class="">
                </div>
                <div class="ml-3 my-auto">
                    <h6>{{ $rayEmployee->name }}</h6>
                    <span>{{ $rayEmployee->email }}</span>
                </div>
            </div>
        </div>

        <a class="dropdown-item" href="{{ route('rayEmployee.show') }}">

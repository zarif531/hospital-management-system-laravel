...
class Receipt extends Model
{
    ...
    {
        return $this->hasOne(PatientAccount::class, 'transaction_id')->where('transaction_type', 'receipt');
    }

    public function fundAccount()
    {
        return $this->hasOne(FundAccount::class, 'transaction_id')->where('transaction_type', 'receipt');
    }
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($receipt) {
            ...
            $receipt->patientAccount->delete();
            $receipt->fundAccount->delete();
        });
    }
}
